...
// Add these to your Window.electronAPI interface in types.ts
interface Window {
    electronAPI: {
      ...
      createNote: () => Promise<string>; // Add this method
      saveSettings: (settings: AppSettings) => Promise<boolean>; // Add this method
      getSettings: () => Promise<AppSettings>; // Add this method
